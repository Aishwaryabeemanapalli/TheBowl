...
<body style="background-image:url('img/home_bg.jpg'); background-repeat:no-repeat;background-size:cover;">
          ...
          echo '<div class="col-xs-3 col-sm-3 col-md-3">
                  <div class="card" style="width: 18rem;">
                    ...
                    <div class="card-body" >
                      ...
                      <a href="viewbowlList.php?catid=' . $id . '" class="btn btn-link">View All</a>
                    </div>
                  </div>
                </div>';
        }
