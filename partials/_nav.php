...
echo '<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav mr-auto">
          ...
          <li class="nav-item">
            <a class="nav-link" style="width=100%" href="viewOrder.php">Your Orders</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" style="width=100%" href="about.php">About Us</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" style="width:100%" href="contact.php">Contact Us</a>
          </li>
