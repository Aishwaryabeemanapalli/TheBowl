    <header class="header" id="header" style="opacity:0.7">
        <div class="header__toggle" style="opacity:0.7">
            <i class='bx bx-menu' id="header-toggle"></i>
        </div>
        
        <div class="header__img" style="opacity:0.7">
            <img src="logo.png" alt="food">
        </div>
    </header>

    <div class="l-navbar" id="nav-bar" style="opacity:0.7">
        <nav class="nav">
            <div>
